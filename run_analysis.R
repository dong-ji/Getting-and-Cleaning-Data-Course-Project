...
write.csv(WholeData_mean_std, "E:\\academic development\\Data Scientist\\Data Science - Johns Hopkins University (Coursera)\\Course 3 Getting and Cleaning Data\\Week 4\\Project\\WholeData_mean_std.csv")
write.csv(subject_activity_mean, "E:\\academic development\\Data Scientist\\Data Science - Johns Hopkins University (Coursera)\\Course 3 Getting and Cleaning Data\\Week 4\\Project\\subject_activity_mean.csv")